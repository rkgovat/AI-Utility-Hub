...
import { marked } from 'marked'; // Converts Markdown to HTML for Word/Excel
  ...
  const downloadPlan = async (format, content, elementId, filenamePrefix) => {
    ...
    if (format === 'pdf') {
      ...
      pdfWrapper.innerHTML = `
        <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #333333; padding: 30px;">
          <style>
            /* Reset default browser margins that cause extra gaps */
            h1, h2, h3, p, ul, li { margin: 0; padding: 0; }

            h1 { color: #1e3a8a; font-size: 24pt; border-bottom: 2px solid #1e3a8a; padding-bottom: 8px; margin-bottom: 15pt; text-align: center; }
            
            /* Tighten H2 margins (Day headers) */
            h2 { color: #1e40af; font-size: 18pt; margin-top: 15pt; margin-bottom: 8pt; border-bottom: 1px solid #e2e8f0; }
            
            /* Tighten H3 margins (Exercise groups) */
            h3 { color: #1e40af; font-size: 13pt; margin-top: 10pt; margin-bottom: 5pt; }
            
            /* Paragraph and List spacing */
            p { margin-bottom: 8pt; font-size: 11pt; }
            ul, ol { margin-bottom: 10pt; margin-left: 20px; }
          ...
          <div style="text-align: center; margin-bottom: 15pt;">
            ...
            <p style="color: #64748b; font-size: 10pt;">Generated by AI Fitness Coach • ${new Date().toLocaleDateString()}</p>
          </div>
          ${htmlContent}
        </div>
      `;
      ...
      const opt = {
        ...
        // CHANGED: Removed 'avoid-all' which causes the large white gaps
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="text" name="frequency" required placeholder="Enter number (e.g. 4)" onChange={handleChange} className="w-full p-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none" />
              </div>
            </div>
          ...
          <div className="mt-8 bg-white p-8 rounded-2xl shadow-lg border-2 border-blue-100">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex gap-2">
                {/* ID 'active-plan-content' is passed to the PDF generator */}
                ...
                <button onClick={() => downloadPlan('excel', response, null, 'My_Fitness_Plan')} className="text-xs bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded shadow">Excel</button>
              </div>
            </div>
            
            {/* ID ADDED HERE FOR PDF GENERATION */}
            <div id="active-plan-content" className="prose prose-slate max-w-none">
                ...
                <details key={item.id} className="group bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="p-6 border-t border-slate-100 bg-gray-50">
                    ...
                    <div className="flex justify-end gap-2 mb-4">
                      ...
                      {/* Unique ID based on Item ID passed to PDF generator */}
